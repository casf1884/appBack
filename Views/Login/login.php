    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg"><strong>Inicie sesión para ingresar al sistema</strong></p>

                <form action="" name="formLogin" id="formLogin">
                    <div class="input-group mb-3">
                        <input name="txtEmail" id="txtEmail" type="email" class="form-control" placeholder="Email Usuario" autocomplete="username">
                    ...
                    <div class="input-group mb-3">
                        <input name="txtPassword" id="txtPassword" type="password" class="form-control" placeholder="Contraseña Usuario" autocomplete="current-password">
                        <div class="input-group-append">
                            <div class="input-group-text">
